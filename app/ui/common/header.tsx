    ...
    <div className="relative">
      ...
      >
        <div className="mobile-container relative">
          ...
          <div
            className={`mobile md:hidden absolute w-full h-screen mobile-container ${
              styles.mobileMenu
            } ${activeMobileBtn ? styles.mobileMenuActive : ""}`}
          >
            ...
            <ul>
              ...
              <li
                className={`${styles.mobileMenuItem} ${
                  styles.mobileMenuItemSubitems
                } ${activeSubitem ? styles.activeSubitem : ""}`}
              >
                <button
                  className={`${styles.mobileMenuLink} ${styles.accordion}`}
                  onClick={() => {
                ...
                <div className={styles.panel}>
                  ...
                  <Link href={"/sipuni"} className={styles.panelLink}>
                    ...
                    <div className={styles.panelInfo}>
                      ...
                      <div className={styles.panelText}>
                        Корпоративная телефония для бизнеса
                      </div>
                    </div>
                  </Link>
                  <Link href={"/web"} className={styles.panelLink}>
                    ...
                    <div className={styles.panelInfo}>
                      ...
                      <div className={styles.panelText}>
                        Полный цикл разработки и запуска сайта
                      </div>
                    </div>
                  </Link>
                </div>
        ...
        >
          <div className="flex justify-between items-center px-fluid">
            <div
              className={styles.menuServicesTextWrapper}
              style={{
                paddingLeft: "calc(18 * (1px + (100vw - 1530px) / 1530))",
              }}
            >
              <div
                className={styles.menuServicesTextTitle}
              >
                Предлагаемые услуги
              </div>
              <div className={styles.menuServicesText}>Внедрение и разработка</div>
            </div>
            <div
              className={styles.lavrWrapper}
            >
              <Lavr transparent={true}></Lavr>
            </div>
          </div>
          <div
            className={`px-fluid flex justify-between ${styles.cardsWrapper}`}
          >
            <ServiceHeaderCard
              link="/amo"
